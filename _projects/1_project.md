...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/PneSteEng_HeroShot.jpg" title="Pneumatic Steam Engine image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
